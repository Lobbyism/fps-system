...
import { Ammo, ComponentNames, HasWeapon, Model, Player, Weapon } from "shared/components";

const remoteEvent = new Instance("RemoteEvent");
remoteEvent.Name = "Replication";
remoteEvent.Parent = ReplicatedStorage;

const REPLICATED_COMPONENTS = new Set<ComponentCtor>([Model, Player, Weapon, HasWeapon, Ammo]);
